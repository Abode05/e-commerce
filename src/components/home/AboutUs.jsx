  ...
  return (
    <section className="relative pt-12 md:py-24  overflow-hidden">
      <div
        ...
        w-3/12 lg:w-full lg:max-w-sm xl:max-w-md bg-violet-800"
      >
        <div className="">
          <img
            className="absolute top-1/2 left-0 transform -translate-y-1/2 
            -translate-x-1/2 z-10 lg:w-72 xl:w-auto  "
            src="/assets/images/01.png"
            alt=""
          />
        </div>

        <img className="w-full h-full " src="/assets/images/bg/04.jpg" alt="" />
      </div>
      ...
      <div className="relative  px-8 ">
        <div className="max-w-md xl:max-w-2xl mx-auto md:mx-0">
          <div className="mb-12 ">
            <h2
              className="font-heading text-4xl xs:text-5xl sm:text-6xl md:text-7xl font-medium
             text-white tracking-tight mb-4"
            >
              About Us
            </h2>
            <p className="max-w-xl text-xl text-gray-500 leading-relaxed tracking-tight mb-6">
              Casper provide instant support, and boost conversions like never
                ...
                <div key={index} className="w-full sm:w-1/2 px-4 mb-8">
                  <div className="relative p-6 rounded-3xl overflow-hidden">
                    ...
                    <div className="relative">
                      ...
                      <span className="block text-xl tracking-tight text-gray-500">
                        {item.text}
                      </span>
                    </div>
                  </div>
