      ...
      <div className="relative px-8 md:px-12 lg:px-16 mt-64 md:mt-4">
        <div className="max-w-md xl:max-w-2xl mx-auto md:mx-0">
          <div className="mb-12">
            ...
            <p className="max-w-xl text-xl text-gray-700 leading-relaxed tracking-tight mb-6">
            ...
            <a
              className="inline-flex items-center  font-medium text-blue-600 hover:text-blue-700 uppercase text-lg"
              href="#"
            >
              <span className="mr-2 flex items-center">
                GET TO KNOW US <MdOutlineArrowOutward />
              </span>
            </a>
          </div>
            ...
            <div className="flex flex-wrap -mx-4 -mb-8">
              {countList.map((item, index) => (
                <div key={index} className="w-full sm:w-1/2 px-4 mb-8">
                  <div className="relative p-6 rounded-3xl overflow-hidden bg-gray-600  hover:bg-opacity-75 transition duration-150">
                    <div className="absolute top-0 left-0 w-full h-full backdrop-filter backdrop-blur-md bg-gray-600     duration-150"></div>
